...
* **Associated ACAI Concepts:** Salvation (ID: `keyterm:Salvation`); Peace (ID: `keyterm:IntactState`); Isaiah (ID: `person:Isaiah`)
...
* **Associated ACAI Concepts:** Shechem (ID: `place:Shechem`); Shechem (ID: `person:Shechem`); Tower of Shechem (ID: `place:TowerOfShechem`)
