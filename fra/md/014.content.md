...
* **Associated ACAI Concepts:** Jean (ID: `person:John.4`); A Disciple (ID: `person:GenericDisciple`); trans. faire un disciple de (ID: `keyterm:Disciple`)
...
* **Associated ACAI Concepts:** saint (ID: `keyterm:Holy`); pur (ID: `keyterm:Clean`)
